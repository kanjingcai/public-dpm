			...
			<ul class="nav ace-nav">
				...
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img
								src="${pageContext.request.contextPath}/static/avatars/avatar.png"
						...
						<li><a href="#"> <img
								src="${pageContext.request.contextPath}/static/avatars/avatar3.png"
						...
						<li><a href="#"> <img
								src="${pageContext.request.contextPath}/static/avatars/avatar4.png"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${pageContext.request.contextPath}/static/avatars/user.jpg"
...
<div class="sidebar-shortcuts" id="sidebar-shortcuts" style="float: left;">
	<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large" style="margin-left: 5px;">
...
<div class="breadcrumbs" id="breadcrumbs" style="position:inherit;">
	<script type="text/javascript">
		try {
