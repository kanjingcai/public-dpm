...
<script src="${pageContext.request.contextPath}/static/js/jqGrid/jquery.jqGrid.min.js"></script>
<script src="${pageContext.request.contextPath}/static/js/jqGrid/i18n/grid.locale-en.js"></script>
